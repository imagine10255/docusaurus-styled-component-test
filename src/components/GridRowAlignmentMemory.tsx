import {GridThemeProvider, Container, Row, Col, Grid, Flex, auto, fr} from 'bear-react-grid';
...
const GridRowAlignmentMemory = () => {
    ...
    return <GridThemeProvider>
        ...
        <Grid col={2} className="mb-3">
            ...
            <GridBox
                style={{
                    gridTemplateColumns: auto(1),
                    gridTemplateRows: auto(3),
                    justifyContent,
                    justifyItems,
                    alignItems,
                    alignContent
...
export default GridRowAlignmentMemory;
