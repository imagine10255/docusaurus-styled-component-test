...
:::tip Tip
In addition to using Components, it is recommended to use pre-built styles moderately to speed up development.

But don’t be as complicated as `Tailwind`, strike a balance

These styles are extracted from `Bootstrap 5`.
...
.text-area-overflow-2{--overflow-line: 2}
...
below supports different size settings, like as this:
